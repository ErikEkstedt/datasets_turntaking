...
# huggingface/datasets/librispeech_asr/librispeech_asr.py
# Only the Feature order is reversed
###################################################################################
###################################################################################
###################################################################################
###################################################################################
...
class LibrispeechASR(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        LibrispeechASRConfig(
            name="other", description="'Other', more challenging, speech."
        ),
    ]
        ...
        if self.config.name == "clean":
            train_splits = [
                datasets.SplitGenerator(
                    name="train.100",
                    gen_kwargs={"archive_path": archive_path["train.100"]},
                ),
                datasets.SplitGenerator(
                    name="train.360",
                    gen_kwargs={"archive_path": archive_path["train.360"]},
                ),
            ]
            ...
            train_splits = [
                datasets.SplitGenerator(
                    name="train.500",
                    gen_kwargs={"archive_path": archive_path["train.500"]},
                ),
            ]
